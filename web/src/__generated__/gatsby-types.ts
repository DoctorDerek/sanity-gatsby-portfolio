...
declare namespace GatsbyTypes {
  ...
  type SanitySampleProject = SanityDocument &
    Node & {
      readonly _id: Maybe<Scalars["String"]>
      readonly _type: Maybe<Scalars["String"]>
      readonly _createdAt: Maybe<Scalars["Date"]>
  ...
  type SitePluginPluginOptionsEmitPluginDocuments = {
    readonly src___generated___gatsby_plugin_documents_graphql: Maybe<
      Scalars["Boolean"]
    >
  }
  ...
  type ProjectTemplateQueryQuery = {
    readonly sampleProject: Maybe<
      Pick<SanitySampleProject, "id" | "publishedAt" | "title" | "_rawBody"> & {
        readonly categories: Maybe<
          ReadonlyArray<Maybe<Pick<SanityCategory, "_id" | "title">>>
        >
        readonly relatedProjects: Maybe<
          ReadonlyArray<
            Maybe<
        ...
        readonly mainImage: Maybe<
          Pick<SanityFigure, "alt"> & {
            readonly crop: Maybe<
              Pick<
                SanityImageCrop,
                "_key" | "_type" | "top" | "bottom" | "left" | "right"
              >
            >
            readonly hotspot: Maybe<
              Pick<
                SanityImageHotspot,
                "_key" | "_type" | "x" | "y" | "height" | "width"
              >
            >
  ...
  type SiteTitleQueryQuery = {
    readonly site: Maybe<Pick<SanitySiteSettings, "title">>
  }
